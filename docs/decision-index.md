...
| Privacy scope | `scope: 'public' \| 'private' \| 'family'` on `PictogramEntry`; user-uploaded defaults to `private`; private records never enter syncOutbox | [#24](https://github.com/lightcoloror/PicInterpreter/issues/24) |
