...
| Receiver persistence | Write ReceiverCorrection records on user edits; two-phase draft → confirm flow | [#26](https://github.com/picinterpreter/picinterpreter/issues/26), [#60](https://github.com/picinterpreter/picinterpreter/issues/60), [#63](https://github.com/picinterpreter/picinterpreter/issues/63), [#64](https://github.com/picinterpreter/picinterpreter/issues/64) |
| Missing token table | MissingTokenRecord status machine (`new → suggested → resolved \| ignored`), caregiver review UI | [#19](https://github.com/picinterpreter/picinterpreter/issues/19), [#62](https://github.com/picinterpreter/picinterpreter/issues/62), [#61](https://github.com/picinterpreter/picinterpreter/issues/61) |
